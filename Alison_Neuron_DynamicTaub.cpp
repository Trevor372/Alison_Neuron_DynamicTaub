#include <Alison_Neuron_DynamicTaub.h>
#include <math.h>
...
{
    return new Alison_Neuron_DynamicTaub();
}
...
Alison_Neuron_DynamicTaub::Alison_Neuron_DynamicTaub(void) : DefaultGUIModel("Alison_Neuron_DynamicTaub", ::vars, ::num_vars) {
    setWhatsThis(
    "<p><b>Alison_Neuron_DynamicTaub:</b><br>This module simulates a neuron with an A Current.</p>");
...
Alison_Neuron_DynamicTaub::~Alison_Neuron_DynamicTaub(void) {}

void Alison_Neuron_DynamicTaub::execute(void) {
...
void Alison_Neuron_DynamicTaub::update(DefaultGUIModel::update_flags_t flag) {
    switch (flag) {
        case INIT:
...
void Alison_Neuron_DynamicTaub::initParameters() {
    V0 = -55.038; // mV
    G_Na_max = 0.24;
    G_K_max = 0.011;
    G_L = 0.0018;
...
void Alison_Neuron_DynamicTaub::solve(double dt, double *y) {
    double dydt[7];
    derivs(y, dydt);
...
void Alison_Neuron_DynamicTaub::derivs(double *y, double *dydt) {
